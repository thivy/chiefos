...
function HeroSection() {
  return (
    <div className="flex flex-col gap-12 md:gap-16">
      <SurfaceContainer className="pb-8 sm:pb-10 md:pb-12">
        <div className="mx-auto max-w-5xl space-y-4 px-4 pt-8 pb-4 lg:px-0">
          ...
          <Text as="h2" variant="display-sm" className="text-foreground/60">
            Your work, already triaged
          </Text>
          <Text as="h1" id="hero-heading" variant="display-lg">
            A digital chief of staff for Copilot Cowork. Nothing important chases you twice.
          </Text>
          <Text as="p" variant="lead">
            ChiefOS scans your inbox, calendar, chat, and meeting recaps twice a day to surface what
      ...
      <ContentContainer>
        <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="bg-card-lilac sm:col-span-2 lg:col-span-3">
            ...
            <CardFooter>
              <SourceMetadata>
                <SourceMetadataCode>visual-minutes.png</SourceMetadataCode>
              </SourceMetadata>
            </CardFooter>
          </Card>
        </div>
